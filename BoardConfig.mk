...
# Vibrator
BOARD_HAS_VIBRATOR_IMPLEMENTATION := ../../device/pantech/ef39s/vibrator/vibrator.c
...
BOARD_EGL_CFG := device/pantech/ef39s/configs/egl.cfg
...
BOARD_MKBOOTIMG_ARGS := 0x1300000
...
BOARD_CUSTOM_GRAPHICS := ../../../device/pantech/ef39s/recovery/graphics.c
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/pantech/ef39s/recovery/recovery_keys.c
